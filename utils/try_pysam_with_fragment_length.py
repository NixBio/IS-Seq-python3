...
# which ensures the insertion site is properly detected. This filter only applies to the read that is first in pair (R1) because these where 
# carring the LTR before alignment.
# 
# input: R1_R2_Barcode_FB-P5-Rd1-LTR.9_FB-P7-Rd2-LC.9_aligned_mem_allFilter_rehead_exact3nt_nonSupplementary.bam
# output: POOL-ISA-AVRO-6-Preclin_FB-P5-Rd1-LTR.9_FB-P7-Rd2-LC.9_final_parse_filterNo.txt(FragmentBased method includes Fragment length)
...
fileNameSplit=re.split('\_',infile )
print(fileNameSplit)
