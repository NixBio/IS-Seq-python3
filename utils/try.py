# This script take as input the *_final_parse.txt of each LTR-LC combination and generates multiple files: 
# one for every single IS (chr and pos), which will contain every read ID corresponding to the IS written in the file name.
